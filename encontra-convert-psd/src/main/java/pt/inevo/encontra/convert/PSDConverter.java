...
/**
 * Class that converts Photoshop(c) Files (PSD) to supported mime-types.
 * Supported mime-types: image/svg+xml, image/png
 * @author rpd
 */
public class PSDConverter implements Converter {
    ...
    private static String PNG_MIMETYPE = "image/png";
    private static String SVG_MIMETYPE = "image/svg+xml";
    ...
    /*Converts the input PSD file to the specified mime type.*/
    public void convertToMimeType(String mimetype, InputStream input, OutputStream output) {
        ...
        } else if (mimetype.equals(PNG_MIMETYPE)) {
